            ...
            <div class="flex">
                ...
                @if ($editingTodoID === $todo->id)
                    <div>
                        ...
                        @if (session('updated'))
                            <span class="text-green-700 text-xs mt-3 block ml-2"> {{ session('updated') }} </span>
                        @endif
                    </div>
                @else
                    <h3 class="text-lg text-semibold text-gray-800 pl-2"> {{ $todo->name }} </h3>
                @endif
